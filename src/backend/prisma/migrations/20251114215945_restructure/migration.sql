...
INSERT INTO "new_Profile" ("careerMode", "date", "faceitElo", "id", "issues", "name", "playerId", "season", "settings", "teamId", "trainedAt", "updatedAt") SELECT "careerMode", "date", "faceitElo", "id", "issues", "name", "playerId", "season", "settings", "teamId", "trainedAt", "updatedAt" FROM "Profile";
DROP TABLE "Profile";
