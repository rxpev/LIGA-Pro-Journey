/*
  ...
  - You are about to drop the column `careerState` on the `Profile` table. All the data in the column will be lost.
  - You are about to drop the column `contractEndDay` on the `Profile` table. All the data in the column will be lost.
  - You are about to drop the column `faceitElo` on the `Profile` table. All the data in the column will be lost.
  - You are about to drop the column `faceitLevel` on the `Profile` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `salary` on the `Profile` table. All the data in the column will be lost.
  - You are about to drop the column `careerState` on the `Player` table. All the data in the column will be lost.
  - You are about to drop the column `contractEndDay` on the `Player` table. All the data in the column will be lost.
  - You are about to drop the column `faceitElo` on the `Player` table. All the data in the column will be lost.
  - You are about to drop the column `faceitLevel` on the `Player` table. All the data in the column will be lost.
  - You are about to drop the column `isUserControlled` on the `Player` table. All the data in the column will be lost.
