...
export enum IPCRoute {
  ...
  NEWS_ALL = '/news/all',
  NEWS_CLEAR_TEST = '/news/clear-test',
  NEWS_GENERATE_TEST = '/news/generate-test',
  NEWS_ITEMS_UPDATED = '/news/items-updated',
  NEWS_UPDATE_MANY = '/news/update/many',
...
export const TierMatchConfig: Record<string, Array<number>> = {
  ...
  [TierSlug.IEM_COLOGNE_OPEN_QUALIFIER]: [3, 3, 3, 3, 1, 1, 1],
  [TierSlug.IEM_COLOGNE_PLAYOFFS]: [5, 3, 3],
  [TierSlug.IEM_KRAKOW_GROUP_A]: [3],
  [TierSlug.IEM_KRAKOW_GROUP_B]: [3],
  [TierSlug.IEM_KRAKOW_OPEN_QUALIFIER]: [3, 3, 3, 3, 1, 1, 1],
