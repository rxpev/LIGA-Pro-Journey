...
export const PrizePool: Record<TierSlug | string, { total: number; distribution: Array<number> }> =
  {
    ...
    [TierSlug.IEM_COLOGNE_PLAYOFFS]: { total: 1_000_000, distribution: [40, 18, 10, 10, 5.5, 5.5, 5.5, 5.5] },
    ...
    [TierSlug.IEM_KRAKOW_PLAYOFFS]: { total: 1_000_000, distribution: [40, 18, 10, 10, 5.5, 5.5, 5.5, 5.5] },
    [TierSlug.LEAGUE_OPEN]: { total: 0, distribution: [] },
    [TierSlug.LEAGUE_OPEN_PLAYOFFS]: { total: 10_000, distribution: [35, 20, 10, 10, 6.25, 6.25, 6.25, 6.25] },
    [TierSlug.LEAGUE_INTERMEDIATE]: { total: 0, distribution: [] },
    [TierSlug.LEAGUE_INTERMEDIATE_PLAYOFFS]: { total: 15_000, distribution: [35, 20, 10, 10, 6.25, 6.25, 6.25, 6.25] },
    [TierSlug.LEAGUE_MAIN]: { total: 0, distribution: [] },
    [TierSlug.LEAGUE_MAIN_PLAYOFFS]: { total: 30_000, distribution: [35, 20, 10, 10, 6.25, 6.25, 6.25, 6.25] },
    [TierSlug.LEAGUE_ADVANCED]: { total: 0, distribution: [] },
    [TierSlug.LEAGUE_ADVANCED_PLAYOFFS]: { total: 70_000, distribution: [35, 20, 10, 10, 6.25, 6.25, 6.25, 6.25] },
    [TierSlug.LEAGUE_PRO]: { total: 0, distribution: [] },
    [TierSlug.LEAGUE_PRO_PLAYOFFS]: { total: 1_000_000, distribution: [40, 18, 10, 10, 5.5, 5.5, 5.5, 5.5] },
    ...
    [TierSlug.MAJOR_CHAMPIONS_STAGE]: { total: 2_500_000, distribution: [40, 18, 10, 10, 5.5, 5.5, 5.5, 5.5] },
  };
