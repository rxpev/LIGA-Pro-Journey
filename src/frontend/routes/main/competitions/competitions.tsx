...
const FIRST_SEASON_STAGE_DATES: Record<string, readonly [number, number]> = {
  ...
  'americas/league:advanced:playoffs': [1775952000000, 1776297600000],
  'asia/league:advanced:playoffs': [1775952000000, 1776470400000],
  'europa/league:advanced:playoffs': [1775952000000, 1776297600000],
  'oceania/league:advanced:playoffs': [1775692800000, 1775952000000],
  'americas/league:intermediate:playoffs': [1775952000000, 1776211200000],
  'europa/league:intermediate:playoffs': [1775952000000, 1776211200000],
  'americas/league:main:playoffs': [1775952000000, 1776211200000],
  'europa/league:main:playoffs': [1775952000000, 1776211200000],
  'americas/league:open:playoffs': [1775952000000, 1776297600000],
  'asia/league:open:playoffs': [1775952000000, 1776211200000],
  'europa/league:open:playoffs': [1775952000000, 1776297600000],
  'oceania/league:open:playoffs': [1775952000000, 1776211200000],
